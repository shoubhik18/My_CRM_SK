  ...
  return (
    <div>
      ...
      {activityStatus === "activity" ? (
        ...
        <NewTask name="campaignId" id={singleCampaignData?.campaign?.id} />
      ) : activityStatus === "new_meeting" ? (
        <NewMeeting name="campaignId" id={singleCampaignData?.campaign?.id} />
      ) : activityStatus === "email" ? (
        <EmailPage name="campaignId" id={singleCampaignData?.campaign?.id} />
      ) : activityStatus === "log_call" ? (
        <LogCall />
      ) : activityStatus === "whatsApp" ? (
        <WhatsApp name="campaignId" id={singleCampaignData?.campaign?.id} />
      ) : activityStatus === "message" ? (
        <Message  name="campaignId" id={singleCampaignData?.campaign?.id}/>
